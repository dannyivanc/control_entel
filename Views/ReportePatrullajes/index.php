<?php include "Views/Templates/header.php";?>
   <div class="card mb-3">
      <div class="card-body text-center bg-opacity-5 bg-black">
         <span class="text-black-75 fs-5">Reporte de Patrullajes</span> 
      </div>
   </div>
      <div >               
   ...
   <table class="table  table-light table-bordered custom-table" id="tblRepPatrullajes">
...
<script src="<?php echo base_url;?>Assets/js/funciones_reporte_patrullajes.js"></script>
